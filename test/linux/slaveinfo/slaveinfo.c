...
static int el2535_setup(uint16 slave)
{
    ...
    el2535_writeu8  (slave, 0x1C13, 0x00, 0);
    el2535_write16  (slave, 0x1C13, 0x01, 0x1a01);
    //el2535_write16  (slave, 0x1C13, 0x02, 0x1a01);
    //el2535_write16  (slave, 0x1C13, 0x03, 0x1a02);
...
//    int64_t                  :8;
//    bool    txpdo_toggle     :1;
//    int16_t info_data_1      :16;
//    int16_t info_data_2      :16;
//} in_EL2535t;
